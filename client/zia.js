...
function ajaxCall1()
{
  ...
  var config = {
      "method":"POST",
      "args":{"case":"testCase55"}
   };
   var functions = catalyst.function;
   var functionObject = functions.functionId(1926000000556403); //can pass Function Id or Function Name as argument
